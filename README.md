...
> [!CAUTION]
> В июне 2025 замечены принтеры K1SE c прошивкой 1.3.5.11 в которой изменен файл toolhead.py, для этих принтеров нужно вместо файла toolhead.py нужно использовать toolhead_1_3_5_11.pyc, предварительно переименовав его в toolhead.pyc
